...
class UpdateProductRequest extends FormRequest
{
    ...
    {
        $product = $this->route('product'); // Since we use Route Model Binding, this should be the Product instance.
        ...
        return [
            ...
            'thumbnail' => ['nullable', 'image', 'mimes:png,jpg,jpeg,webp', 'max:2048'], // nullable on update
