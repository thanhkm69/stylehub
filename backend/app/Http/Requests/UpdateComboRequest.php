...
class UpdateComboRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'combo_type'     => 'required|in:fixed_combo,buy_get,bundle',
            'discount_type'  => 'required|in:percentage,fixed_price,bundle_price',
    ...
    public function messages(): array
    {
        return [
            ...
            'combo_type.required'     => 'Loại combo không được để trống.',
            'combo_type.in'           => 'Loại combo không hợp lệ.',
