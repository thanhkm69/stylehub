...
class StoreAttributeValueRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'value' => 'required|string|max:100|unique:attribute_values,value,NULL,id,attribute_id,' . $this->attribute_id,
            'slug' => 'required|string|max:100|unique:attribute_values,slug,NULL,id,attribute_id,' . $this->attribute_id,
