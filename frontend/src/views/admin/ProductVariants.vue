        ...
        <BaseForm @handleSubmit="submit">
            ...
            <template #button>
                <div class="form-actions">
                    <BaseButton @click="closeForm" customType="button" customText="Hủy bỏ" customClass="btn-cancel" />
                    <BaseButton v-if="!loadingSubmit" customType="submit" :customText="isEdit ? 'Lưu thay đổi' : 'Thêm'"
                        :disabled="loadingSubmit" customClass="btn btn-primary" />
